namespace Iterators
{
    ...
    public static class Java8StreamOperations
    {
        ...
        public static IEnumerable<Tuple<int, TAny>> Indexed<TAny>(this IEnumerable<TAny> sequence)
        {
            ...
            {
                yield return new Tuple<int, TAny>(i, sequence.ElementAt(i));
            }
        }
        ...
        {
            return sequence.Filter(e => !predicate(e));
        }
        ...
        {
            return sequence.Indexed().SkipWhile(tuple => tuple.Item1 <= count).Map(tuple => tuple.Item2);
        }
        ...
        {
            return sequence.Indexed().Filter(tuple => tuple.Item1 < count).Map(tuple => tuple.Item2);
        }
