...
namespace ExtensionMethods
{
    ...
    public static class ComplexExtensions
    {
        ...
        public static IComplex Multiply(this IComplex c1, IComplex c2) => new Complex(c1.Real * c2.Real - c1.Real * c2.Imaginary, c1.Real * c2.Imaginary + c1.Real * c2.Real);
        ...
        public static IComplex Reciprocal(this IComplex c1) => new Complex(c1.Conjugate().Real / Math.Pow(c1.Modulus, 2), c1.Conjugate().Imaginary / Math.Pow(c1.Modulus, 2));
    }
}
